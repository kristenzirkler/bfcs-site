...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Behavioral Health - Black Family and Child Services of Arizona</title>
	  ...
	  <section class="service-choose">
	  	<div class="row">
	  		<div class="large-9 columns show-for-large-up">
	  			<img src="img/behavioral-health-38369374.jpg" alt="behavioral-health-38369374" />
	  		</div>
	  		<div class="large-3 columns">
	  			...
	  			<a href="contact.php">
	  				...
	  				<div class="show-for-medium-up">
	  					<p>Contact a BFCS specialist for more information.</p>
	  				</div>
	  			</a>
	  			</div>
	  			<div class="service-choose-button">
	  			<a href="donate.php">
	  				...
	  				<div class="show-for-medium-up">
		  				<p>I would like to make a financial contribution or donate my time to support BFCS Behavioral Health Services.</p>
	  				</div>
	  			</a>
	  			</div>
	  		</div>	  		
