...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Family Enhancement - Black Family and Child Services of Arizona</title>
	  ...
	  <section class="service-choose">
	  	<div class="row">
	  		<div class="large-9 columns show-for-large-up">
	  			<img src="img/family-enhancement-21487769.jpg" alt="family-enhancement-21487769" />
	  		</div>
	  		<div class="large-3 columns">
	  			...
	  			<a href="donate.php">
	  				...
	  				<div class="show-for-medium-up">
		  				<p>I would like to make a financial contribution or donate my time to support the BFCS Family Enhancement Services.</p>
	  				</div>
	  			</a>
	  			</div>
	  		</div>	  		
